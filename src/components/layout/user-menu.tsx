...
import {Calendar, ChevronDown, FileText, HelpCircle, LinkIcon, Lock, LogOut, Menu, UserCircle} from 'lucide-react'
...
export default ((props) => {
    ...
    return (
        <div className="UserMenu">
                ...
                <SheetContent side="left" className="p-0 max-w-full rounded-t-xl">
                    <SheetHeader className="p-4 border-b">
                        <SheetTitle className="flex items-center space-x-3">
                            <div
                                className="w-12 h-12 rounded-full bg-blue-600 text-white flex items-center justify-center text-lg font-semibold">
            ...
            <DropdownMenu>
                <DropdownMenuTrigger
                    className="hidden sm:flex items-center justify-center gap-2 cursor-pointer focus:outline-none focus:ring-0">
                    <div
                ...
                <DropdownMenuContent
                    className="absolute top-full right-0 mt-2 w-72 sm:w-80 bg-white rounded-xl shadow-xl border border-gray-100 py-4 z-50">
