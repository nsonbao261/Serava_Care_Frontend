        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-300 mb-6 text-sm leading-relaxed">
              Ứng dụng chăm sóc sức khỏe trực tuyến 24/7, kết nối bạn với hơn
              1000 bác sĩ và 125 cơ sở y tế uy tín trên toàn quốc.
            </p>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start text-sm">
                ...
                <span>
                  Tầng 10, Tòa nhà ABC, 123 Nguyễn Trãi, Thanh Xuân, Hà Nội
                </span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div
              className={`${
                activeDropdown === "support" ? "block" : "hidden md:block"
              }`}
            >
      ...
      <div className="bg-gray-950 border-t border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
            <div className="mb-4 md:mb-0">
              <p>
                © {currentYear} Công ty TNHH Serava Care Việt Nam. Tất cả quyền
                được bảo lưu.
              </p>
              <p className="mt-1">
                Giấy phép ĐKKD số 0123456789 do Sở KH&ĐT TP. Hồ Chí Minh cấp
                ngày 01/01/2024.
              </p>
            </div>
          ...
          <div className="mt-4 pt-4 border-t border-gray-800">
            <p className="text-xs text-gray-500 text-center">
              Các thông tin trên Serava Care chỉ dành cho mục đích tham khảo,
              tra cứu và không thay thế cho việc chẩn đoán hoặc điều trị y khoa.
