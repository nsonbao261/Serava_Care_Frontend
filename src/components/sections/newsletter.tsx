    ...
    <section className="py-16 bg-white relative">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="flex items-center justify-center mb-6">
                ...
                <h2 className="text-2xl md:text-3xl font-bold text-gray-800">ĐĂNG KÝ NHẬN THÔNG TIN CỦA CHÚNG TÔI</h2>
            </div>

            <p className="text-gray-600 mb-8 text-lg">Nhận thông tin sức khỏe hữu ích và ưu đãi đặc biệt từ Serava
                Care</p>
            ...
            <p className="text-gray-500 text-sm mt-4">
                ...
                <a href="/chinh-sach-bao-mat" className="underline hover:text-blue-600 text-blue-500">
                    Chính sách bảo mật
                </a>{' '}
                của chúng tôi
            </p>
