      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Hội đồng tham vấn y khoa cùng đội ngũ chuyên gia là các bác sĩ, dược
            sĩ hàng đầu đảm bảo chất lượng dịch vụ chăm sóc sức khỏe tốt nhất
            cho bạn
          </p>
        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 text-center">
          ...
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
            Dễ đọc, dễ hiểu cho mọi đối tượng với sự đảm bảo chất lượng từ đội
            ngũ chuyên gia y tế hàng đầu
          </p>
