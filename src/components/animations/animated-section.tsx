...
export default ((props) => {
    const {children, className = '', animation = 'simple', delay = 0, duration = 700} = props
    ...
    return <div ref={ref} className={`${getAnimationClasses()} ${className}`} style={animationStyle}>{children}</div>
}) satisfies React.FC<{
