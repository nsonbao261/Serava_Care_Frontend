...
export const mockDoctorDetails: { [key: string]: DoctorDetail } = {
   'bs-ckii-nguyen-van-minh': {
      ...
      about: 'BS.CKII Nguyễn Văn Minh có hơn 20 năm kinh nghiệm trong lĩnh vực Tim mạch can thiệp. Bác sĩ Minh hiện đang là Trưởng khoa Tim mạch tại Bệnh viện Chợ Rẫy. Với chuyên môn và kinh nghiệm dày dặn, Bác sĩ Minh luôn được nhiều bệnh nhân tin tưởng đến thăm khám và điều trị.',
      education: [
