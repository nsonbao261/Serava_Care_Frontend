import { DoctorDetail } from "@/types/specialty";
...
export const mockDoctorDetails: { [key: string]: DoctorDetail } = {
  "bs-ckii-nguyen-van-minh": {
    ...
    about:
      "BS.CKII Nguyễn Văn Minh có hơn 20 năm kinh nghiệm trong lĩnh vực Tim mạch can thiệp. Bác sĩ Minh hiện đang là Trưởng khoa Tim mạch tại Bệnh viện Chợ Rẫy. Với chuyên môn và kinh nghiệm dày dặn, Bác sĩ Minh luôn được nhiều bệnh nhân tin tưởng đến thăm khám và điều trị.",
    education: [
  ...
  "ts-bs-tran-thi-huong": {
    ...
    about:
      "TS. BS Trần Thị Hương chuyên về Nhi khoa - Nội tiết với hơn 15 năm kinh nghiệm. Bác sĩ Hương hiện đang công tác tại Bệnh viện Nhi Đồng 1, chuyên điều trị các bệnh lý nội tiết ở trẻ em như đái tháo đường, rối loạn tăng trưởng, rối loạn tuyến giáp.",
    education: [
