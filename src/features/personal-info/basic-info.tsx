            ...
            <FormField
                ...
                render={({field}) => (<FormItem>
                    ...
                    <FormControl>
                        ...
                        >
                            <SelectTrigger
                                className={cn('w-full py-5 transition-colors', !isEditing && 'bg-gray-100')}
                            >
                    ...
                    render={({field}) => (<FormItem>
                        ...
                        <FormControl>
                           <textarea
                               ...
                               rows={3}
                               disabled={!isEditing}
                               className={cn('border-1 rounded-md resize-y py-2 px-4 transition', !isEditing && 'resize-none bg-gray-100')}
                           />
                        </FormControl>
                        <FormMessage/>
                    </FormItem>)}
...
}) satisfies React.FC<{ userProfile: ProfileFormData }>
