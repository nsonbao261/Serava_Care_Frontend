...
export default function DoctorsPage() {
  ...
  useEffect(() => {
    ...
    if (selectedSpecialty !== "Tất cả chuyên khoa") {
      filtered = filtered.filter(
        (doctor) =>
          doctor.specialty && doctor.specialty.includes(selectedSpecialty)
      );
    }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Tìm kiếm và đặt lịch khám với hơn 1000+ bác sĩ chuyên khoa uy tín
              trên toàn quốc
            </p>
          </div>
        </div>
        ...
        {currentDoctors.length > 0 ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-sm text-gray-500 mt-2">
              This means either no data was loaded or filtering removed all
              results.
            </p>
          </div>
        )}
          ...
          <div className="text-center py-12">
            ...
            {searchTerm && (
              <div className="space-x-4">
                <Link
                  href={`/bac-si/chuyen-khoa?search=${encodeURIComponent(
                    searchTerm
                  )}`}
                >
